...
type PubSubClient interface {
	...
	// 2. Server receives request and delivers events until X events are delivered to client via one ore more FetchResponse messages.
	...
	// at a new position in the stream.
	//
	...
	// was provided in the first FetchRequest. Otherwise, the RPC will return an
	// error with the INVALID_ARGUMENT status.
